...
void gen_tnp(enum sTokenKind, union Address op1, union Address op2, Type t_op1, Type t_op2);
void gen_instructions(enum sTokenKind ction_inst,union Address t, union Address op1, union Address op2,Type t_t, Type t_op1, Type t_op2);
